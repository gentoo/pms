...
\item[CONFIG\_PROTECT, CONFIG\_PROTECT\_MASK] Contain whitespace-delimited lists of directories used
    to control the configuration file protection. Described more fully in chapter
    \ref{config-protect}.
