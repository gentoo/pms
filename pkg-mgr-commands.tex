...
extensions are \t{png}, \t{gif}, \t{html}, \t{htm}, \t{jpg}, \t{css}, and \t{js}. These default
...
\item[doman] Installs a man page into the appropriate subdirectory of \t{/usr/share/man} depending
    ...
    In EAPIs listed in table~\ref{doman-table} as supporting language codes, \t{foo.lang.1} shall
    go to \t{/usr/share/man/lang/man1/foo.1}.
