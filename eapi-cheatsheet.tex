...
\begin{description}
    ...
    longer exports its defined shell variables to the environment,
    except for certain path variables. The same applies to variables
    defined in \code{make.defaults} that have specific meanings.
    See \featureref{export-vars}.
