...
\fixme{Do we require specific ordering for A and AA? Some ebuilds rely upon it. Should they be
allowed to? What about exact whitespace? Do we mandate exactly one space separation and no leading
or trailing space?}
