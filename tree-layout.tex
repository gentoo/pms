...
directory, support files needed by these eclasses. Ebuilds and eclasses can access such files only
in EAPIs listed in table~\ref{tab:removed-env-vars-table} as supporting \t{ECLASSDIR}.
